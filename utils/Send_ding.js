...
async function sendToDingtalk(data) {
  if (data.toString().indexOf('Số còn') != -1) { 
    console.log('Data1: ' + data.toString().indexOf('Số còn'));
    console.log('Data2: ' + data.toString().indexOf('Số không còn'));
    axios
  ...
  if (data.toString().indexOf('Số không còn') != -1) {
    console.log('Data3: ' + data.toString().indexOf('Số còn'));
    console.log('Data4: ' + data.toString().indexOf('Số không còn'));
    axios
